...
@track selectedFields = {selectedFieldsContact:''};
disableSubmit = true;
...
//showSpinner = true;
        ...
        this.refreshComponent(); 
            ...
            .then(result => {
                ...
                for(var i = 0; i < this.resultList.length; i ++){
                    var accObj = this.resultList[i].Account;
                    if(accObj != null){
                        this.resultList[i].AccountName = accObj.Name;
                    }
    ...
    openModal(event) {
     ...
     closeModal(event) {
        ...
        this.selectedFields.selectedFieldsContact = '';
    ...
    handleChangeContact(event){
        ...
        if(this.selectedFields.selectedFieldsContact == ''){ 
            this.disableSubmit=true;
        }
        else{
            this.disableSubmit=false;
    ...
    navigateToListView(event){
        window.open(
            this.currentPageUrl.substring(0,this.currentPageUrl.indexOf('/') + 1) +'003',
            "_self"
          );
    }
